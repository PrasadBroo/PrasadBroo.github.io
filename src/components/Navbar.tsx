...
export default function Navbar() {
  ...
  const listClassNames = clsx(
    "md:static md:flex md:items-center overflow-y-hidden  md:text-base lg:text-xl  md:overflow-clip  ease-in transition-[height]  py-2 md:py-0 md:pointer-events-auto shadow-md md:shadow-none md:justify-between md:h-auto transition text-xl absolute  left-0 right-0  top-14 border-b border-gray-700 md:border-none",
    {
  ...
  return (
    <nav className="p-4  sticky top-0  z-10 md:flex   md:items-center shadow-md md:justify-between border-b dark:border-gray-700 border-gray-300">
      ...
      <ul className={listClassNames}>
        ...
        <div className="switch p-3 hover:bg-gray-200 dark:hover:bg-purple-primary dark:hover:bg-purple-800 rounded-xs">
          <ToggleThemeButton />
        </div>
      </ul>
    </nav>
